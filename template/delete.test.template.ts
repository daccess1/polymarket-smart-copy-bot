...
import plugin from "../src/plugins/PLUGIN_PATH/delete.REQUEST_ENDPOINT.js";
...
describe.sequential("SAMPLE_TYPE REQUEST_ENDPOINT tests", () => {
    ...
    it("should successfully DELETE REQUEST_ENDPOINT", async () => {
    ...
    it("should fail DELETE REQUEST_ENDPOINT with incorrect body params", async () => {
        const response = await fastify.inject({
            method: "DELETE",
            url: "/REQUEST_URL",
            body: {
